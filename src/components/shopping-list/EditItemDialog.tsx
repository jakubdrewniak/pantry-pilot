...
import type { ShoppingListItem, EditItemFormData, EditItemFormErrors } from '@/types/types'
 ...
 *
 * Modal dialog for editing shopping list item quantity and unit.
...
export function EditItemDialog({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.unit && formData.unit.trim().length > 50) {
      newErrors.unit = 'Unit must be at most 50 characters'
    }
