 ...
 * The recipe is associated with the user's household.
 *
 * Creation method can be specified in the request body:
 * - 'manual' (default): User created recipe from scratch
 * - 'ai_generated': Recipe generated by AI and saved without modifications
 * - 'ai_generated_modified': AI recipe that was edited before saving
 *
 * Headers:
 ...
 * - creationMethod?: 'manual' | 'ai_generated' | 'ai_generated_modified' (defaults to 'manual')
 *
 * Response:
