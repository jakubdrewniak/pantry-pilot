...
- After implementation, review what was learned and ask question that will examine if crucial elements of implementation steps are understandable (you can give a hint to the question) and only then suggest next steps.
...
## 6. Documentation Guidelines (YAGNI Principle)

**Default approach: Minimal, focused documentation**

- **Start minimal**: Create ONE concise documentation file (50-100 lines max) covering essentials only
- **Ask before expanding**: If you think more documentation might be helpful, ASK first
- **Avoid over-engineering**: Don't create multiple README files, EXAMPLES.md, CHECKLIST.md etc. unless explicitly requested
- **Code comments over docs**: Prefer well-commented code over separate documentation files
- **Just-in-time documentation**: Add more docs only when the user asks or when complexity truly requires it

**When creating documentation:**

- Focus on "getting started" and common issues
- Keep it actionable (what to do, not encyclopedia)
- Link to official docs for deep dives
- One file is usually enough

**Red flags (avoid these):**

- Creating 3+ documentation files without being asked
- Writing 200+ line README for simple features
- Documenting edge cases that may never happen
- Creating EXAMPLES.md "just in case"

**Remember**: The user is experienced and can read code. Documentation should enable quick start, not replace thinking.

---

_These rules ensure the AI remains a teaching partner, not just an executor._
